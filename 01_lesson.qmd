...
<font color="#55b748">**Step 1:**</font> Install urbnmapr `remotes::install_github("UrbanInstitute/urbnmapr")`, load the urbnmapr library, and update the urbnthemes style to map `set_urbn_defaults(style = "map")`.
